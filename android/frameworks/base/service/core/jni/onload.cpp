...
// begin add register_android_server_HelloworldService by Shihao.Zheng
int register_android_server_HelloworldService(JNIEnv* env);
// end add register_android_server_HelloworldService by Shihao.Zheng
};
...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* /* reserved */)
{
    ...
    // bigin add register helloworld jni method by Shihao.Zheng
    register_android_server_HelloworldService(env);
    // bigin end register helloworld jni method by Shihao.Zheng
