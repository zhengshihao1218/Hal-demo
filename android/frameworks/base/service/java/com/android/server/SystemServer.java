...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        try {
            ...
            // begin start helloworld Service by Shihao.Zheng
            t.traceBegin("StartHelloWorldService");
            ServiceManager.addService("helloworld", new HelloWorldService(context));
            t.traceEnd();
            // end start helloworld Service by Shihao.Zheng
